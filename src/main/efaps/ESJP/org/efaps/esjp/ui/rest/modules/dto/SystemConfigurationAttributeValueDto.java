...
@JsonDeserialize(builder = SystemConfigurationAttributeValueDto.Builder.class)
@EFapsUUID("b9cf0553-e6db-4e5c-aba8-2ccae738cd09")
@EFapsApplication("eFaps-WebApp")
public class SystemConfigurationAttributeValueDto
{
    ...
    private SystemConfigurationAttributeValueDto(Builder builder)
    {
    ...
    public static final class Builder
    {
        ...
        public SystemConfigurationAttributeValueDto build()
        {
            return new SystemConfigurationAttributeValueDto(this);
        }
    }
